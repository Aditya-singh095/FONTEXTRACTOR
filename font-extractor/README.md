...
<p align="center">
  <a href="https://vercel.com/new/clone?repository-url=https://github.com/Aditya-singh095/FONTEXTRACTOR&root=font-extractor">
...
| **Deployment** | Static build — one-click deploy to [Vercel](https://vercel.com), Netlify, or GitHub Pages |
| **Config** | `vercel.json` included — no dashboard setup needed |
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Aditya-singh095/FONTEXTRACTOR&root=font-extractor)

> **Note:** When importing into Vercel manually, set the **Root Directory** to `font-extractor`. The included `vercel.json` handles build config automatically.
